...
private:
	...
	class CGameContext *m_pGS;
public:
	CBroadcasterBolo(class CGameContext *pGameServer);
	virtual ~CBroadcasterBolo();
...
class CGameControllerBoloFNG : public IGameController
{
private:
	...
	class CBroadcasterBolo m_Broadcast;
...
public:
	...
	virtual ~CGameControllerBoloFNG();
